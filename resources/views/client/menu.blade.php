                                ...
                                <div class="detail-box">
                                    ...
                                    <div class="options">
                                        ...
                                        <form action="{{ route('cart.store') }}" method="POST" enctype="multipart/form-data">
                                          ...
                                          <input type="hidden" value="{{ $product->poster_url }}"  name="image">
                                          <input type="hidden" value="{{ $product->description }}"  name="image">
                                          <input type="hidden" value="{{ $product->category_id }}"  name="image">
